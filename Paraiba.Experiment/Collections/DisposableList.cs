...
namespace Paraiba.Collections
{
		...
		where T : IDisposable
	{
		...
		///</summary>
		///<param name="item">
		///<see cref="TValue:System.Collections.Generic.ICollection`1" /> に追加するオブジェクト。
		///</param>
		///<exception cref="TValue:System.NotSupportedException">
		///<see cref="TValue:System.Collections.Generic.ICollection`1" /> は読み取り専用です。
		///</exception>
		...
		///</returns>
		///<param name="item">
		///<see cref="TValue:System.Collections.Generic.ICollection`1" /> 内で検索するオブジェクト。
		///</param>
		...
		///</summary>
		///<param name="array">
		///<see cref="TValue:System.Collections.Generic.ICollection`1" /> から要素がコピーされる 1 次元の <see cref="TValue:System.Array" />。<see cref="TValue:System.Array" /> には、0 から始まるインデックス番号が必要です。
		///</param>
		...
		///</returns>
		///<param name="item"><see cref="TValue:System.Collections.Generic.IList`1" /> 内で検索するオブジェクト。
		///</param>
		...
		///</summary>
		///<param name="n"><paramref name="item" /> を挿入する位置の、0 から始まるインデックス番号。
		///</param>
		///<param name="item"><see cref="TValue:System.Collections.Generic.IList`1" /> に挿入するオブジェクト。
		///</param>
		///<exception cref="TValue:System.ArgumentOutOfRangeException"><paramref name="n" /> が <see cref="TValue:System.Collections.Generic.IList`1" /> の有効なインデックスではありません。
		///</exception>
		///<exception cref="TValue:System.NotSupportedException"><see cref="TValue:System.Collections.Generic.IList`1" /> は読み取り専用です。
		///</exception>
		...
		///</exception>
		///<exception cref="TValue:System.NotSupportedException">
		///このプロパティが設定されていますが、<see cref="TValue:System.Collections.Generic.IList`1" /> が読み取り専用です。
		///</exception>
