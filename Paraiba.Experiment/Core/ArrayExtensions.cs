...
namespace Paraiba.Core
{
    public static class ArrayExtensions
    {
        ...
        public static void ForEachReverse<T>(this T[,] array, Action<T, int, int> action)
        {
            var nRow = array.GetLength(1);
            var nColumn = array.GetLength(0);
            for (int c = 0; c < nColumn; c++)
        ...
        public static IEnumerable<TResult> Select<T, TResult>(this T[,] array, Func<T, int, int, TResult> func)
        {
            var nRow = array.GetLength(1);
            var nColumn = array.GetLength(0);
            for (int r = 0; r < nRow; r++)
        ...
        public static IEnumerable<TResult> SelectReverse<T, TResult>(this T[,] array, Func<T, int, int, TResult> func)
        {
            var nRow = array.GetLength(1);
            var nColumn = array.GetLength(0);
            for (int c = 0; c < nColumn; c++)
        ...
        /// <returns>行の値の列挙子</returns>
        public static IEnumerable<T> GetRow<T>(T[,] matrix, int rowIndex, int columnLength)
        {
        ...
        /// <returns>行の値の列挙子</returns>
        public static IEnumerable<T> GetRow<T>(T[,] matrix, int rowIndex, int columnStartIndex, int columnLength)
        {
        ...
        public static IEnumerable<T> GetColumn<T>(this T[,] matrix, int columnIndex)
        {
        ...
        /// <returns>列の値の列挙子</returns>
        public static IEnumerable<T> GetColumn<T>(T[,] matrix, int columnIndex, int rowLength)
        {
        ...
        /// <param name="rowLength">取得する範囲内にある列の要素数</param>
        /// <returns>列の値の列挙子</returns>
        public static IEnumerable<T> GetColumn<T>(T[,] matrix, int columnIndex, int rowIndex, int rowLength)
        {
        ...
        public static bool IsValidIndex<T>(this T[,] array, int index0, int index1)
        {
            return 0 <= index0 && index0 < array.GetLength(0) && 0 <= index1 && index1 <= array.GetLength(1);
        }
    }
}