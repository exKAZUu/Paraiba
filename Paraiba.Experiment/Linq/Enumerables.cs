...
namespace Paraiba.Linq {
    public static class Enumerables {
        ...
        /// <typeparam name="TSource"> The type of the elements of source. </typeparam>
        /// <param name="source"> A sequence to be judged. </param>
        /// <param name="cmp"> An IComparer <(Of
        ///                                   <(TSource>)>) to compare elements. </param>
        /// <returns> true if the source sequence is sorted; otherwise, false. </returns>
        public static bool IsSorted<TSource>(
            this IEnumerable<TSource> source, IComparer<TSource> cmp) {
            Contract.Requires(source != null);
        ...
        public static IEnumerable<TSource> AlternatelyConcat<TSource>(
            this IEnumerable<TSource> source1, IEnumerable<TSource> source2) {
        ...
        public static IEnumerable<TResult> CastWithoutNull<TResult>(
        ...
        public static IEnumerable<TResult> CastWhere<TResult>(
            this IEnumerable source) {
            foreach (var item in source) {
                if (item is TResult) {
        ...
        public static IEnumerable<Tuple<T1, T2>> DirectProduct<T1, T2>(
        ...
        /// <param name="action"> 各要素に適用する関数 </param>
        /// <returns> 処理した要素数 </returns>
        public static int ForEach2<T>(
            this IEnumerable<IEnumerable<T>> source, Action<T> action) {
        ...
        /// <returns> 処理した要素数 </returns>
        public static int ForEach2<T>(
            this IEnumerable<List<T>> source, Action<T> action) {
            // HACK: 共変性の導入(IEnumerable<IList<T>> への対応)
            Contract.Requires(source != null);
            Contract.Requires(action != null);
        ...
        /// <returns> 処理した要素数 </returns>
        public static int ForEach2<T>(
            this IEnumerable<List<T>> source, Action<T, int, int> action) {
            // HACK: 共変性の導入(IEnumerable<IList<T>> への対応)
            Contract.Requires(source != null);
            Contract.Requires(action != null);
        ...
        /// <returns> 処理した要素数 </returns>
        public static int ForEach<T>(
            this IEnumerable<T> source, Action<T> action, Action<T> action2) {
            Contract.Requires(source != null);
            Contract.Requires(action != null);
        ...
        public static IEnumerable<Tuple<T1, TSecond>> Zip<T1, TSecond>(
            this IEnumerable<T1> first, IEnumerable<TSecond> second) {
            return first.Zip<T1, TSecond, Tuple<T1, TSecond>>(second, Tuple.Create);
        }

        public static bool TryGetFirst<TResult>(
            this IEnumerable<TResult> source, out TResult first) {
            Contract.Requires(source != null);
        ...
        public static bool TryGetFirst<TResult>(
            this IEnumerable<TResult> source, Func<TResult, bool> predict,
            out TResult first) {
            Contract.Requires(source != null);
        ...
        public static IEnumerable<Tuple<TResult, TResult>> Zip2Chain<TResult>(
        ...
        public static IEnumerable<Tuple<TResult, TResult, TResult>> Zip3Chain
                <TResult>(this IEnumerable<TResult> source) {
            using (var itr = source.GetEnumerator()) {
                if (itr.MoveNext()) {
        ...
        public static IEnumerable<Tuple<TResult, TResult, TResult, TResult>>
                Zip4Chain<TResult>(this IEnumerable<TResult> source) {
            using (var itr = source.GetEnumerator()) {
                if (itr.MoveNext()) {
                    var last1 = itr.Current;
                    if (itr.MoveNext()) {
                        ...
                        if (itr.MoveNext()) {
                            ...
                            while (itr.MoveNext()) {
                                var item = itr.Current;
                                yield return
                                        Tuple.Create(last1, last2, last3, item);
        ...
        public static IEnumerable<TResult> Repeat<TResult>(
            this IEnumerable<TResult> source, int count) {
            while (--count > 0) {
                foreach (var item in source) {
                    yield return item;
                }
        ...
        public static int ForEachApartFirst<T>(
            this IEnumerable<T> source, Action<T> firstAction,
            Action<T> action) {
            Contract.Requires(source != null);
        ...
        public static int ForEachApartLast<T>(
            this IEnumerable<T> source, Action<T> action,
            Action<T> lastAction) {
            Contract.Requires(source != null);
            Contract.Requires(action != null);
        ...
        public static IEnumerable<TResult> SelectApartFirst<TSource, TResult>(
            this IEnumerable<TSource> source,
        ...
        public static IEnumerable<TResult> SelectApartLast<TSource, TResult>(
            this IEnumerable<TSource> source,
            Func<TSource, TResult> selector,
        ...
        public static IEnumerable<T> Concat<T>(
            this IEnumerable<T> source, T last) {
            foreach (var item in source) {
                yield return item;
            }
        ...
        public static IEnumerable<T> ConcatFirst<T>(
            this IEnumerable<T> source, T first) {
            yield return first;
        ...
        public static List<T> ToList<T>(
            this IEnumerable<T> source, int capacity) {
        ...
        public static bool ReferenceEqualsItems<T>(
        ...
        public static bool EqualsItems<T>(
            this IEnumerable<T> source1, IEnumerable<T> source2) {
        ...
        public static IEnumerable<IList<T>> Split<T>(
            this IEnumerable<T> source, Func<T, bool> isSeparatorFunc) {
            using (var itr = source.GetEnumerator()) {
                // 空のシーケンスに対しては何もしない
                if (!itr.MoveNext()) {
                    yield break;
        ...
        public static IEnumerable<IList<T>> SplitWithoutEmpty<T>(
            this IEnumerable<T> source,
        ...
        public static IEnumerable<T> PickUpFirst<T>(
        ...
        public static IEnumerable<T> PickUpFirst<T>(
            this IEnumerable<IList<T>> sources) {
            foreach (var source in sources) {
        ...
        public static IEnumerable<T> PickUpFirst<T>(
            this IEnumerable<IList<T>> sources, Func<T, bool> predicate) {
            foreach (var source in sources) {
                yield return source.First(predicate);
            }
        }

        public static IEnumerable<T> PickUpValidFirst<T>(
            this IEnumerable<IEnumerable<T>> sources) {
            foreach (var source in sources) {
                foreach (var item in source) {
                    yield return item;
        ...
        public static bool IsIntersect<T>(
            this IEnumerable<T> source1, IEnumerable<T> source2) {
        ...
        public static IEnumerable<T> Planarize<T>(
            this IEnumerable<IEnumerable<T>> sources) {
            foreach (var source in sources) {
                foreach (var item in source) {
                    yield return item;
        ...
        public static IEnumerable<T> Planarize<T>(
            this IEnumerable<List<T>> sources) {
            foreach (var source in sources) {
                foreach (var item in source) {
                    yield return item;
                }
        ...
        public static IEnumerable<T> TakeWhileWithNext<T>(
            this IEnumerable<T> source, Func<T, bool> func) {
            foreach (var item in source) {
                yield return item;
                if (!func(item)) {
                    break;
        ...
        public static IEnumerable<T> OddIndexElements<T>(
            this IEnumerable<T> source) {
        ...
        public static IEnumerable<T> EvenIndexElements<T>(
            this IEnumerable<T> source) {
            using (var etr = source.GetEnumerator()) {
                etr.MoveNext();
                if (etr.MoveNext()) {
        ...
        public static Tuple<List<T>, List<T>> Halve<T>(
            this IEnumerable<T> source, Func<T, bool> classifier) {
        ...
        public static LinkedList<TSource> ToLinkedList<TSource>(
            this IEnumerable<TSource> source) {
