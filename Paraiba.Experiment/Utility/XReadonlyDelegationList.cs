...
{
	public class ReadonlyListWrapper<TItem> : ReadonlyListWrapper<IList<TItem>, TItem>
	{
	...
	public class ReadonlyListWrapper<TList, TItem> : ReadonlyListWrapper<IWrap<TList>, TList, TItem>
	...
	public class ReadonlyListWrapper<TWrap, TList, TItem> : XReadonlyListWrapper<TWrap, TList, TItem, TItem>
	...
	public class XReadonlyListWrapper<TOrgItem, TItem> : XReadonlyListWrapper<IList<TOrgItem>, TOrgItem, TItem>
	...
	public class XReadonlyListWrapper<TList, TOrgItem, TItem> : XReadonlyListWrapper<IWrap<TList>, TList, TOrgItem, TItem>
	...
	/// 委譲により読み込み専用の IList インタフェースの実装を提供します。
	/// なお、ジェネリクスの型引数における共変性も実現します。
	/// </summary>
	/// <typeparam name="TWrap"></typeparam>
	/// <typeparam name="TList"></typeparam>
	/// <typeparam name="TOrgItem"></typeparam>
	/// <typeparam name="TItem"></typeparam>
	public class XReadonlyListWrapper<TWrap, TList, TOrgItem, TItem> : IList<TItem>
		where TWrap : IWrap<TList>
		where TList : IList<TOrgItem>
		where TOrgItem : TItem
	{
		...
		{
			if (item is TOrgItem || (default(TOrgItem) == null && default(TItem) == null && item == null))
