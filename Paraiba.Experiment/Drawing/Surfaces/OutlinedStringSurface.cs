...
namespace Paraiba.Drawing.Surfaces
{
	...
	public class OutlinedStringSurface : Surface
	{
		...
		public OutlinedStringSurface(String str, Font font, Brush brush, Pen outlinePen)
			: this(str, font, brush, outlinePen, null)
		{
		}

		public OutlinedStringSurface(String str, Font font, Brush brush, Pen outlinePen, StringFormat stringFormat)
		{
