...
namespace Paraiba.Algorithm
{
	...
	{
		private static void Merge<T>(IList<T> list, IComparer<T> cmp, int left, int center, int right, T[] work)
		{
		...
		public static void MergeSort<T>(IList<T> list, IComparer<T> cmp, int left, int right, T[] work)
		{
			Contract.Requires(list != null);
			Contract.Requires(cmp != null);
			Contract.Requires(0 <= left);
		...
		public static void InsertionSort<T>(IList<T> list, IComparer<T> cmp, int left, int right)
        {
			Contract.Requires(list != null);
			Contract.Requires(cmp != null);
			Contract.Requires(0 <= left);
