namespace Paraiba.TaskList
{
	...
	public abstract class BasicTaskList<TTask> where TTask : class
	{
		private int _count;
	...
	public struct TaskArgs<TArg1>
	{
		...
		public TaskArgs(TaskList<TArg1> list, TaskNode<TaskList<TArg1>.Task> thisTask)
		{
			List = list;
			ThisTask = thisTask;
		}
	...
	public struct TaskArgs<TArg1, TArg2>
	{
		...
		public TaskArgs(TaskList<TArg1, TArg2> list, TaskNode<TaskList<TArg1, TArg2>.Task> thisTask)
		{
			List = list;
			ThisTask = thisTask;
		}
	...
	public class TaskList<TArg1, TArg2> : BasicTaskList<TaskList<TArg1, TArg2>.Task>
	{
		#region Delegates

		public delegate void Task(TaskArgs<TArg1, TArg2> taskArgs, TArg1 arg1, TArg2 arg2);
	...
	public struct TaskArgs<TArg1, TArg2, TArg3>
	{
		...
		public TaskArgs(TaskList<TArg1, TArg2, TArg3> list, TaskNode<TaskList<TArg1, TArg2, TArg3>.Task> thisTask)
		{
			List = list;
			ThisTask = thisTask;
		}
	...
	{
		void Task(TaskArgs<TArg1, TArg2, TArg3> taskArgs, TArg1 arg1, TArg2 arg2, TArg3 arg3);
	}

	public class TaskList<TArg1, TArg2, TArg3> : BasicTaskList<TaskList<TArg1, TArg2, TArg3>.Task>
	{
		#region Delegates

		public delegate void Task(TaskArgs<TArg1, TArg2, TArg3> taskArgs, TArg1 arg1, TArg2 arg2, TArg3 arg3);
		...
		public void Evoke(TArg1 arg1, TArg2 arg2, TArg3 arg3)
		{
			...
			while (node != _head)
			{
				node._task(new TaskArgs<TArg1, TArg2, TArg3>(this, node), arg1, arg2, arg3);
				node = node._next;
			}
		}
	}
